...
def test_location():
    assert parsed_items[0]["location"] == {
        "name": "Eastside Food Co-op",
        "address": "2551 Central Ave. NE., Minneapolis, MN 55418"
    }


def test_source():
    assert parsed_items[0]["source"] == "https://lims.minneapolismn.gov/Boards/Meetings/CentralAvenue"


def test_links():
    assert parsed_items[4]["links"] == [{
        "title": "Report Document",
      "href": "https://lims.minneapolismn.gov/Download/CommitteeReport/1026/Central-Avenue-Special-Service-District-Advisory-Board-1-23-2020.pdf"
    }]
