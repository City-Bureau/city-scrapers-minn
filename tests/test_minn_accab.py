...
from city_scrapers.spiders.minn_accab import MinnAccabSpider

test_response = file_response(
    join(dirname(__file__), "files", "minn_accab.html"),
    url="https://lims.minneapolismn.gov/Calendar/GetCalenderList?fromDate=Dec%2031,%202017&toDate=none&meetingType=2&committeeId=35&pageCount=10000&offsetStart=0&abbreviation=ZBA&keywords=&sortOrder=6",
)
spider = MinnAccabSpider()
