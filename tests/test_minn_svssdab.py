...
from city_scrapers.spiders.minn_svssdab import MinnSvssdabSpider

test_response = file_response(
    join(dirname(__file__), "files", "minn_svssdab.html"),
    url="https://lims.minneapolismn.gov/Calendar/GetCalenderList?fromDate=Dec%2031,%202017&toDate=none&meetingType=2&committeeId=163&pageCount=10000&offsetStart=0&abbreviation=ZBA&keywords=&sortOrder=6",
)
spider = MinnSvssdabSpider()
